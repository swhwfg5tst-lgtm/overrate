...
session_set_cookie_params([
    ...
    'path'     => '/',
    'secure'   => $isHttps,   // true ТОЛЬКО если HTTPS
    'httponly' => true,       // JS не увидит cookie
    'samesite' => 'Strict',   // защита от CSRF через cookie
]);
...
// защита от пустых POST-запросов
if (empty($_POST)) {
...
if ($telegram_token === '' || $telegram_chat === '') {
    $env = load_env_file(__DIR__ . '/config/.env');
